...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-2 w-full bg-secondary backdrop-blur-md z-50 transition-all duration-300">
      <div className="max-w-10xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <button className="cursor-pointer px-6 py-2 bg-sidebar-accent-foreground text-white rounded-full font-medium hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300">
              Sign Up
            </button>
          </div>
